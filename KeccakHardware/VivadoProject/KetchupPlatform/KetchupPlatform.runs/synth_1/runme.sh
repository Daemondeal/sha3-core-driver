...
HD_PWD='/home/daem/Desktop/group9/KeccakHardware/VivadoProject/KetchupPlatform/KetchupPlatform.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processing_wrapper.tcl
