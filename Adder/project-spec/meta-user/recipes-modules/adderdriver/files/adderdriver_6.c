/*  adder.c - The simplest kernel module.
...
MODULE_AUTHOR
    ("Xilinx Inc.");
MODULE_DESCRIPTION
    ("adder - loadable module template generated by petalinux-create -t modules");
...
static int adder_probe(struct platform_device *pdev)
{
    ...
    pr_info("probe mem_start --> 0x%08x\n", lp->mem_start);
    pr_info("probe mem_start --> 0x%08x\n", lp->mem_end);
...
static int __init adder_init(void)
{
	...
	printk("<1>Module parameters were (0x%08x) and \"%s\"\n", myint,
	       mystr);
    int i = platform_driver_register(&adder_driver);
