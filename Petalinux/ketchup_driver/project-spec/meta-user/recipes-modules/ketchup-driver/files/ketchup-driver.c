/*  ketchup-driver.c - The simplest kernel module.
...
MODULE_AUTHOR
    ("Xilinx Inc.");
MODULE_DESCRIPTION
    ("ketchup-driver - loadable module template generated by petalinux-create -t modules");
...
static struct of_device_id ketchup_driver_of_match[] = {
	{ .compatible = "vendor,ketchup-driver", },
	{ /* end of list */ },
};
MODULE_DEVICE_TABLE(of, ketchup_driver_of_match);
#else
# define ketchup_driver_of_match
#endif
